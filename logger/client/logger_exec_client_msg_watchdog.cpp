...
logger_exec_client_msg_watchdog::logger_exec_client_msg_watchdog() :
   _messageFromServer()
{
   // do nothing
}

logger_exec_client_msg_watchdog::logger_exec_client_msg_watchdog( const ProtoLogger::Logger_Message msg ) :
   _messageFromServer( msg )
{
   // do nothing
}

std::string logger_exec_client_msg_watchdog::create()
{
...
void logger_exec_client_msg_watchdog::process()
{
